@props(["header" => true, "sectionHeader"])
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/exams" aria-current="page"
                                    class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">Exams</a>
                                <a href="/questions"
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            @guest
                                <div class="ml-10 flex items-baseline space-x-4">
                                    <a href="/login"
                                        class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('login') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">Login</a>
                                    <a href="/register"
                                        class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('register') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">Register</a>
                                </div>
                            @endguest
