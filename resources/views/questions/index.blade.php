<x-layout>
    ...
    <div class="flex flex-col gap-4">
        @foreach ($questions as $question)
            <div class="lg:flex lg:items-center lg:justify-between bg-blue-100 px-6 py-4 rounded-xl">
                <div class="min-w-0 flex-1">
                    <a href="questions/{{ $question->id }}" class="text-2xl/7 font-bold text-gray-900 sm:truncate sm:text-2xl sm:tracking-tight">
